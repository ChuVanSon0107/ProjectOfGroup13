	...
	public World(Player player) {
		...
		if(MainMenu.getLevel() == 0) {
			 // room 0
	    	   ...
	    	   rooms[1].getEnemies().add(new ADFire(13, 5, Vector.Up, 2, 2, Resources.AD1, 0, rooms[1], 20, false, 0, 25));
	    	   ...
	    	   rooms[2].getEnemies().add(new Monster(11, 4, Vector.Up, 2, 2, Resources.MONSTER1, Resources.MONSTER1_ATTACK, 1, rooms[2], 40, false, 1, 20));
	    	   // room 3
